...
define config.name = _("Escape From MPT Nahim Edition")
...
define build.name = "EscapeFromMPTNahimEdition"
...
define config.save_directory = "EscapeFromMPTNahimEdition-1730313277"
